  ...
  switch (eventType) {
    ...
    case "02":
      return {
        ...
        anchor: "experience",
        title_blurb: "Please see some of the Work Experience that I have.",
      }
    case "03":
      return {
        ...
        anchor: "courses",
        title_blurb: "Please see some of the courses that I have completed.",
      }
    case "04":
      return {
...
function getTier1Icon(category) {
  ...
  switch (val) {
    case "data analytics":
      return '<i class="fa-solid fa-chart-simple" aria-hidden="true"></i>' // modern for bar-chart
    case "dev-ops":
    ...
    case "qa engineering":
      return '<i class="fa fa-square-check" aria-hidden="true"></i>' // modern for check-square-o
    case "artificial intelligence":
      return '<i class="fa fa-brain" aria-hidden="true"></i>' // replacement for nonstandard "check-brain"
    case "video":
      return '<i class="fa-brands fa-youtube" aria-hidden="true"></i>' // replacement for nonstandard "check-brain"
        ...
        <div class="card-body">
          <div class="event-content">
            ...
            <div class="event-description">
              ${shortDesc}${
    isLong ? ` <a href="${link}" class="more-inline">more →</a>` : ""
  }
            </div>
          </div>
          <div class="card-foot">
            <span class="eid">${
              item.e_id !== undefined && item.e_id !== null ? item.e_id : ""
            }</span>
          </div>
        </div>
      </div>
